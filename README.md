...
This repository contains the code generated by PowerApps for the Foodbank Worker Portal which is one part of my FYP. **For a full overview of the project I recommend reading this [Blog Submission]() and watching this [Video Overview of the Project](https://youtu.be/5YJZpnZifrY)**<br><br>
